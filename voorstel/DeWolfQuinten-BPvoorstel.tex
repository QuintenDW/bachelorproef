...
\keywords{Bun, Back-end, framework}

\begin{document}

\begin{abstract}
  In de voorbije jaren zijn er alsmaar nieuwe javascript runtime omgevingen ontwikkeld met telkens nieuwe verbeteringen. 
  ...
  In dit onderzoek wordt bestudeerd of het nieuwe javascript runtime omgeving Bun 
  een correcte plaatsvervanger is voor Node.js bij de ontwikkeling van complexe webapplicaties.
  Hiervoor werd voor beide frameworks een proof-of-concept gemaakt waarop performantie testen werden uitgevoerd.
  Daarnaast werden ook hun respectievelijke package managers en bundlers vergeleken. 
  Het resultaat zijn verschillende metingen van beide frameworks die kunnen worden vergeleken.
  Op basis van deze vergelijking kan een keuze worden gemaakt tussen het gebruik van Node.js en Bun.
\end{abstract}
