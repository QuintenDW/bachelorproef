...
\begin{table}[]
    ...
    \begin{tabular}[c]{@{}c@{}}De omgeving moet goede prestaties bieden\end{tabular}                                                               & x                       & x                        &                          &                              & x                           &                           \\ \cline{1-1}
    ...
    \end{tabular}
    \caption[Requirements tabel]{\label{tab:requirements}Omgevingen afgetoetst aan de requirements}
    \end{table}
...
waardoor het boven de minimumdrempel van 1\% zit.
...
Deze omgeving wordt, samen met Node.js, in het proof-of-concept verwerkt om hierop dan performantie metingen uit te voeren.
...
De overige omgevingen voldoen niet aan de minimum requirements waardoor ze al zeker niet zullen worden opgenomen in het proof-of-concept.
...
Aangezien dit onderzoek zich focust op de performantie van de omgevingen, wordt gekozen om Bun op te nemen in het proof-of-concept.