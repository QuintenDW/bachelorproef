...
Daarna worden de alternatieven in de lijst afgetoetst aan deze requirements om zo tot tot één geschikte omgeving te komen die wordt vergeleken met Node.js.
...
moet de omgeving platformonafhankelijk zijn, wat betekent dat het op verschillende besturingssytemen kan draaien.
...
\section{Selectie}
Nu dat de requirements bepaald zijn, worden de JavaScript runtime-omgevingen hier tegenover afgetoetst.
Deze lijst van JavaScript runtime-omgevingen is gebasseerd op de samengestelde lijst van \textcite{Errilaz2023} 
...
Deze zal als basis dienen om uit de lijst de runtime-omgeving te kiezen voor de vergelijking met Node.js.
\begin{table}[H]
    \begin{tabular}{|c|}
    \hline
